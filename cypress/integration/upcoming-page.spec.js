...
describe("Upcoming Page ", () => {
  ...
  describe("Selecting Must Watch", () => {
    it("should display an avatar for tagged movies and list them on the Must Watch page", () => {      
      ...
      cy.get("header").find(".MuiToolbar-root").find("button").eq(5).find(".MuiButton-label").contains('Must Watch');
      cy.get(".MuiCardHeader-content").should(
        "have.length",
        2
      );
